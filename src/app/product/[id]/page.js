       ...
       <div className="bg-[#F7F7F7] border-b-2 border-amber-300 flex flex-col gap-2 w-full px-2 pt-3"> 
        ...
        <div className="w-full h-full flex flex-col  "> 
         ...
         <div className="w-full h-full flex flex-col  px-4 mt-1">
           ...
           {/* Dinamik Specs - Tüm özellikler otomatik gösterilir */}
           {currentProduct.product.specs && Object.entries(currentProduct.product.specs).map(([key, value]) => (
             value && (
               <div key={key} className="w-full py-2 flex items-center justify-between border-b border-gray-200">
                 <p className="text-[12px] text-gray-700">{key}</p>
