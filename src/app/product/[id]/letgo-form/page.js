    ...
    const createStyledComponent = async () => {
      ...
      const component = styled(Stepper)`
        ...
        & .MuiStepIcon-root.Mui-active {
          color: rgb(254, 67, 90);
          transform: scale(1);
          filter: drop-shadow(0 0 8px rgba(254, 67, 90, 0.3));
        }
...
const page = () => {
  ...
  // Add Navbar component after imports
  const Navbar = () => {
    return (
      <div className="w-full bg-white border-b border-gray-200 px-4 py-3">
        <div className="flex items-center gap-4">
          ...
          <Image src={logo} alt="letgo" className="h-8 w-auto" />
        </div>
      </div>
    );
  };
  ...
  return (
    <>
      <Head>
        <title>Letgo - Cüzdanım Güvende</title>
      </Head>
            ...
            <div className='w-full h-auto flex flex-col'> 
             <div className='flex flex-col w-full  bg-[#E8F6F4] border-t border-gray-300 px-3 pt-3'> 
              ...
              <div className='w-full flex gap-3 items-center justify-between border-b border-[#b2d1cc] py-3'> 
                 <p className='text-sm text-gray-700'>Letgo Cüzdanım Güvende Hizmet Bedeli</p>
             ...
             <div className='w-full h-full flex flex-col bg-[#F7F7F7] py-4'> 
               ...
               <div className='flex flex-col gap-2 bg-white w-full h-auto border-t border-gray-300 pt-3 pb-2 px-4 mt-3'>
                 <p className='text-xs text-gray-600'>LETGO CÜZDANIM GÜVENDE HİZMET SÖZLEŞMESİ</p>
                 ...
                 <div className='h-32 overflow-y-auto border border-gray-200 rounded-md p-2 mt-1'>
                   <p className='text-[10px] text-gray-600 leading-relaxed'>
                     Bu sözleşme, sahibinden.com ("Platform") üzerinden gerçekleştirilen alışverişlerde kullanılan Letgo Cüzdanım Güvende hizmetine ilişkin olarak, hizmeti kullanan alıcı ("Kullanıcı") ile Platform arasında akdedilmiştir. Letgo Cüzdanım Güvende hizmeti, Platform üzerinden gerçekleştirilen alışverişlerde ödemenin güvenli bir şekilde yapılmasını ve ürünün teslim alınmasından sonra satıcıya aktarılmasını sağlayan bir hizmettir.

                     Hizmetin Kullanımı:
                     1. Kullanıcı, Platform üzerinden bir ürün satın almak istediğinde Letgo Cüzdanım Güvende hizmetini seçebilir.
                     ...
                     Hizmet Bedeli:
                     Letgo Cüzdanım Güvende hizmeti için Platform, işlem tutarının %1.9'u oranında hizmet bedeli tahsil eder. Bu bedel, işlem tutarına dahil edilir ve Kullanıcı tarafından ödenir.
              ...
              <div className='flex flex-col gap-4 px-3 py-3 bg-white'> 
                 ...
                 <div className='flex flex-col gap-[1px] '> 
                  ...
                  <input 
                    ...
                    className={`w-full border ${errors.name ? 'border-red-500' : 'border-gray-400'} p-2 outline-none focus:border-[rgb(254,67,90)] focus:ring-1 focus:ring-[rgb(254,67,90)] transition-all duration-300`} 
                  />
                  ...
                  <div className='flex flex-col gap-[1px] '> 
                    ...
                    <input 
                      ...
                      onChange={handleInputChange}
                      className={`w-full border ${errors.surname ? 'border-red-500' : 'border-gray-400'} p-2 outline-none focus:border-[rgb(254,67,90)] focus:ring-1 focus:ring-[rgb(254,67,90)] transition-all duration-300`} 
                    />
                  ...
                  <div className='flex flex-col gap-[1px]'> 
                    ...
                    <input 
                      ...
                      className={`w-full border ${errors.phone ? 'border-red-500' : 'border-gray-400'} p-2 outline-none focus:border-[rgb(254,67,90)] focus:ring-1 focus:ring-[rgb(254,67,90)] transition-all duration-300 placeholder:text-gray-400 placeholder:text-sm`}  
                    />
                  ...
                  <div className='flex flex-col gap-[1px] '> 
                    ...
                    <input 
                      ...
                      className={`w-full border ${errors.addressName ? 'border-red-500' : 'border-gray-400'} p-2 outline-none focus:border-[rgb(254,67,90)] focus:ring-1 focus:ring-[rgb(254,67,90)] transition-all duration-300 placeholder:text-gray-400 placeholder:text-sm`} 
                    />
                  ...
                  <div className='flex flex-col gap-[1px] '> 
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={`w-full border ${errors.province ? 'border-red-500' : 'border-gray-400'} p-2 outline-none focus:border-[rgb(254,67,90)] focus:ring-1 focus:ring-[rgb(254,67,90)] transition-all duration-300 text-sm rounded appearance-none pr-8`}
                      >
                  ...
                  <div className='flex flex-col gap-[1px] '> 
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={`w-full border ${errors.district ? 'border-red-500' : 'border-gray-400'} p-2 outline-none focus:border-[rgb(254,67,90)] focus:ring-1 focus:ring-[rgb(254,67,90)] transition-all duration-300 text-sm rounded appearance-none pr-8`}
                      >
                        <option value="" disabled>Seçiniz</option>
                  ...
                  <div className='flex flex-col gap-[1px] '> 
                    ...
                    <textarea 
                      ...
                      className={`w-full border ${errors.address ? 'border-red-500' : 'border-gray-400'} p-2 outline-none focus:border-[rgb(254,67,90)] focus:ring-1 focus:ring-[rgb(254,67,90)] transition-all duration-300 placeholder:text-gray-400 placeholder:text-sm min-h-[100px] resize-y`}
                      rows="4"
                    ></textarea>
           ...
           <div className='flex flex-col gap-4 border bg-white  pb-16'> 
              ...
              <div className='flex flex-col px-4 gap-4'> 
                ...
                <div className='flex flex-col gap-3  '> 
                  <p className='text-sm bg-[rgb(254,67,90)] px-3 py-1 rounded-sm w-fit text-white'>Letgo Muhasebe Departmanı</p>

                  <div className='flex flex-col py-3 justify-center border-l-4 border-[rgb(254,67,90)] pl-3'> 
                  ...
                  <div className='flex flex-col py-1 justify-center border-l-4 border-[rgb(254,67,90)] pl-3'> 
                    <div className="flex items-center gap-2">
          ...
          <div className="fixed inset-0 backdrop-blur-[8px] bg-black/20 flex items-center justify-center z-50 animate-blurIn">
            <div className="bg-white/95 rounded-md py-6 px-12 flex flex-col items-center gap-4 animate-modalIn shadow-lg">
              ...
              <button
                ...
                className="bg-[rgb(254,67,90)] text-white px-6 py-2 rounded-md hover:bg-[rgb(254,67,90)] transition-colors"
              >
                Tamam
              </button>
            </div>
